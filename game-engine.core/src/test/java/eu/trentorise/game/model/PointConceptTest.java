...
public class PointConceptTest {
    ...
    public void addAPeriod() {
        ...
        Assert.assertEquals(Double.valueOf(25), pc.getPeriodCurrentScore(0));
    }
    ...
    public void persistPeriod() {
        ...
        Assert.assertEquals(Double.valueOf(35), p.getPeriodCurrentScore(0));
    }
    ...
    public void morePeriods() {
        ...
        Assert.assertEquals(Double.valueOf(21), p.getPeriodCurrentScore(0));
        Assert.assertEquals(Double.valueOf(21), p.getPeriodCurrentScore(1));
    ...
    public void currentInstanceScore() {
        ...
        Assert.assertEquals(Double.valueOf(29), p.getPeriodCurrentScore("period1"));
        Assert.assertEquals(Double.valueOf(14), p.getPeriodCurrentScore("period2"));
    }
    ...
    public void previousInstanceScore() {
        ...
        Assert.assertEquals(Double.valueOf(10), p.getPeriodPreviousScore("period1"));
        Assert.assertEquals(Double.valueOf(1), p.getPeriodPreviousScore("period2"));
    }
    ...
    public void previousInstanceScoreOfNonExistingPeriod() {
        ...
        Assert.assertEquals(Double.valueOf(0), p.getPeriodPreviousScore("period45"));
    }
    ...
    public void instanceScoreByIndex() {
        ...
        Assert.assertEquals(Double.valueOf(10), p.getPeriodScore("period1", 0));
        Assert.assertEquals(Double.valueOf(4), p.getPeriodScore("period2", 0));
        Assert.assertEquals(Double.valueOf(10), p.getPeriodScore("period2", 1));
        Assert.assertEquals(Double.valueOf(1), p.getPeriodScore("period2", 2));
    }
    ...
    public void instanceScoreByDate() {
        ...
        Assert.assertEquals(Double.valueOf(1),
    ...
    public void instanceScoreByNonExistingIndex() {
        ...
        Assert.assertEquals(Double.valueOf(0), p.getPeriodScore("period2", 10));
    }
    ...
    public void instanceByIndex() {
        ...
        Assert.assertEquals(Double.valueOf(1), instance.getScore());
    ...
    public void instanceByNonExistingIndex() {
        PointConcept p = setupPointConceptWithPeriods();
        Assert.assertEquals(Double.valueOf(0), p.getPeriodInstance("period2", 20).getScore());
    }
    ...
    public void previousInstanceScoreByFutureDate() {
        ...
        Assert.assertEquals(Double.valueOf(0), p.getPeriodPreviousScore("period1"));
        Assert.assertEquals(Double.valueOf(0), p.getPeriodPreviousInstance("period1").getScore());
    }
    ...
    public void previousInstanceByFutureDate() {
        ...
        Assert.assertEquals(Double.valueOf(0), instance.getScore());
    }
    ...
    public void tryInRules() throws InterruptedException {
        ...
        Assert.assertEquals(Double.valueOf(4), ((PointConcept) playerSrv
