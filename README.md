...
<picture style="width:5rem">
  <source media="(prefers-color-scheme: dark)" srcset="./game-engine.webapp/public/univaq-logo-light.png">
  <source media="(prefers-color-scheme: light)" srcset="./game-engine.webapp/public/univaq-logo-dark.png">
  <img style="width:5rem" alt="Univaq Logo" src="./game-engine.webapp/public/univaq-logo-dark.png">
</picture>
<picture style="width:6rem">
  <source media="(prefers-color-scheme: dark)" srcset="./game-engine.webapp/public/logo-light.png">
  <source media="(prefers-color-scheme: light)" srcset="./game-engine.webapp/public/logo-dark.png">
  <img style="width:6rem" alt="GamificationHub Icon" src="./game-engine.webapp/public/logo-dark.png">
</picture>
<picture style="width:30rem">
  <source media="(prefers-color-scheme: dark)" srcset="./game-engine.webapp/public/app-logo-light.png">
  <source media="(prefers-color-scheme: light)" srcset="./game-engine.webapp/public/app-logo-dark.png">
