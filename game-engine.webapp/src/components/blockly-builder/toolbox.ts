    ...
    contents: [
        {
            ...
            contents: [
                { kind: 'block', type: 'drool_imports' },
                { kind: 'block', type: 'drool_package' },
                { kind: 'block', type: 'drool_import' },
                { kind: 'block', type: 'drool_globals' },
                { kind: 'block', type: 'drool_global' },
                { kind: 'block', type: 'drool_declare' },
                { kind: 'block', type: 'drool_attribute' },
                { kind: 'block', type: 'drool_function' },
                { kind: 'block', type: 'drool_return' },
            ],
        },
        {
            kind: 'category',
        ...
        },
        {
            ...
            contents: [
                ...
                { kind: 'block', type: 'drool_while' },
                { kind: 'block', type: 'drool_for_each' },
                { kind: 'block', type: 'drool_for' },
                { kind: 'block', type: 'drool_var_decl' },
                { kind: 'block', type: 'drool_method_call' },
                { kind: 'block', type: 'drool_switch' },
                { kind: 'block', type: 'drool_case' },
                { kind: 'block', type: 'drool_default' },
                { kind: 'block', type: 'drool_if' },
                { kind: 'block', type: 'drool_if_else' },
                { kind: 'block', type: 'drool_return' },
